...
3. 目标 Agent 项目不在当前工作目录，而是在 `D:\ClaudeCode_Code\anthropic-ai-claude-code-2.1.88-restored`。
...
1. `D:\claude\package.json`
2. `D:\claude\agent_eval\core.js`
3. `D:\claude\agent_eval\loader.js`
4. `D:\claude\agent_eval\report.js`
5. `D:\claude\agent_eval\cli.js`
6. `D:\claude\examples\demo_suite.js`
7. `D:\claude\examples\demo_agent.js`
8. `D:\claude\README.md`
...
`D:\claude\reports\demo-report.json`
...
1. `D:\claude\examples\stdio_demo_agent.config.json`
2. `D:\claude\examples\stdio_demo_agent.js`
3. `D:\claude\examples\stdio_agent_template.py`
...
随后在 `D:\claude\agent_eval\adapters.js` 中新增了 `claude_code_cli` 适配器。
...
1. `D:\claude\agent_eval\report.js`
2. `D:\claude\agent_eval\cli.js`
...
我在 `D:\claude\examples\claude_code_capability_suite.js` 中逐步增加了这类任务，最终形成 6 个任务：
...
所以在 `D:\claude\examples\claude_code_regression_suite.js` 中，我专门挑选了更短、更稳定的任务，默认每题 2 个 trial：
...
`D:\claude\examples\claude_code_repo_grounded_suite.js`
...
`D:\claude\examples\claude_code_repo_agent.config.json`
...
1. `D:\claude\agent_eval\matrix.js`
2. `D:\claude\examples\claude_code_eval_matrix.js`
...
`D:\claude\reports\claude-code-matrix`
...
在 `D:\claude\examples\claude_code_eval_matrix.js` 中，默认 gate 是：
...
1. `D:\claude\agent_eval\core.js`
2. `D:\claude\agent_eval\adapters.js`
3. `D:\claude\agent_eval\loader.js`
4. `D:\claude\agent_eval\cli.js`
5. `D:\claude\agent_eval\report.js`
6. `D:\claude\agent_eval\matrix.js`

### 15.2 示例与配置层

1. `D:\claude\examples\demo_suite.js`
2. `D:\claude\examples\demo_agent.js`
3. `D:\claude\examples\stdio_demo_agent.config.json`
4. `D:\claude\examples\stdio_demo_agent.js`
5. `D:\claude\examples\stdio_agent_template.py`
6. `D:\claude\examples\claude_code_agent.config.json`
7. `D:\claude\examples\claude_code_repo_agent.config.json`
8. `D:\claude\examples\claude_code_capability_suite.js`
9. `D:\claude\examples\claude_code_regression_suite.js`
10. `D:\claude\examples\claude_code_repo_grounded_suite.js`
11. `D:\claude\examples\claude_code_eval_matrix.js`
12. `D:\claude\examples\demo_eval_matrix.js`
13. `D:\claude\examples\workspace_suite_utils.js`

### 15.3 产出与文档层

1. `D:\claude\README.md`
2. `D:\claude\reports\...`
3. `D:\claude\docs\agent-eval-tool-build-process.zh-CN.md`
4. `D:\claude\docs\agent-eval-claude-code-evaluation-process.zh-CN.md`
...
`D:\claude\reports\demo-matrix\matrix-summary.json`
...
`D:\claude\reports\claude-code-matrix\matrix-summary.json`
